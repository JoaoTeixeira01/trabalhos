...
public class Arbitros extends Jogos{
	...
	public Arbitros(int numCartaoCidadao, String nome, Date dataNascimento, int contacto, String email) {
		super();
		this.numCartaoCidadao = numCartaoCidadao;
		this.nome = nome;
		this.dataNascimento = dataNascimento;
	...
	public String toString() {
		return "Arbitros [numCartaoCidadao=" + numCartaoCidadao + ", nome=" + nome + ", dataNascimento="
